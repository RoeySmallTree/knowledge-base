...
- Write produces markdown content, NOT JSON content
- The content field should be well-formatted markdown
- changeSummary should be specific about what was addressed
